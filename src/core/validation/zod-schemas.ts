...
import {
  ScopedIndexSchema as ScopedContractsIndexSchema,
  ScopedConfigSchema,
  PlanOnlyConfigSchema,
  PasteConfigSchema,
  SeedResolutionResultSchema
} from './scoped-contracts.js';
import { RefactorReportSchema } from './refactor-report.js';
import { PastePackResultSchema } from './paste-pack.js';
...
export const SCHEMA_REGISTRY = {
  ...
  // New scoped-pack contracts
  'scoped/plan-only-index': ScopedContractsIndexSchema,
  'scoped/config': ScopedConfigSchema,
  'scoped/plan-only-config': PlanOnlyConfigSchema,
  'scoped/paste-config': PasteConfigSchema,
  'scoped/seed-resolution': SeedResolutionResultSchema,
  // Refactor report schemas
  'refactor-report': RefactorReportSchema,
  'refactor-report-paste': TextArtifactSchema,
  // Paste pack schemas
  'paste-pack': PastePackResultSchema,
  'paste-pack-text': TextArtifactSchema
} as const;
