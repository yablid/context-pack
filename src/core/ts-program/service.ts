...
export class TsProgramService {
  ...
  /**
   * Find nearest tsconfig to a seed file
   */
  static findNearestTsConfig(seedPath: string): string | undefined {
    const candidates = ['tsconfig.json', 'jsconfig.json'];
    let currentDir = dirname(resolve(seedPath));
