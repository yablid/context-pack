...
import type { Artifact, ScopedConfig } from '../../../core/types.js';
import { TsProgramService } from '../../../core/ts-program/service.js';
import { GraphBuilder } from '../../scoped-pack/graph-builder.js';
import { Ranker } from '../../scoped-pack/ranker.js';
import { Slicer } from '../../scoped-pack/slicer.js';
import { StubGenerator } from '../../scoped-pack/stubber.js';
import { ScopedPackager } from '../../scoped-pack/packager.js';
import type { ScopedScope } from '../../../core/validation/scoped-scope.js';

// NOTE: ScopedConfig moved to core/types.ts to break cycles
